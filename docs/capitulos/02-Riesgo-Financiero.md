...
Esto no elimina la necesidad de estimar el *ARO*, pero obliga a una **revisión continua** de sus variables, alimentadas por evidencia técnica objetiva (Ver **Anexo F**):
